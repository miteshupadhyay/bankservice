...
CREATE USER scv_user WITH PASSWORD 'admin';
GRANT ALL PRIVILEGES ON DATABASE "DB_501" to scv_user;

create table cust_bank_info(
cust_id BIGINT PRIMARY KEY ,
acc_bal BIGINT NOT NULL,
...
http://localhost:8080/bank-service/swagger-ui